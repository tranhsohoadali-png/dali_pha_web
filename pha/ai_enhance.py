...
_PROMPT_PHOTO = config("AI_PROMPT_PHOTO", default=(
    ...
    "in their own rosy/red tone with the lip line visible. Give these features "
    "their OWN distinct flat colors (do NOT let the iris, lashes or lips wash into "
    "the skin tone), and keep their edges sharp and clean — never blurred or melted. "
